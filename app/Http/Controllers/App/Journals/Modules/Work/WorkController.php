...
final class WorkController extends Controller
{
    public function update(Request $request): RedirectResponse
    {
        ...
        new LogWork(
            ...
            workMode: array_key_exists('work_mode', $validated) ? TextSanitizer::plainText($validated['work_mode']) : null,
            workLoad: array_key_exists('work_load', $validated) ? TextSanitizer::plainText($validated['work_load']) : null,
            workProcrastinated: array_key_exists('work_procrastinated', $validated) ? TextSanitizer::plainText($validated['work_procrastinated']) : null,
        )->execute();
