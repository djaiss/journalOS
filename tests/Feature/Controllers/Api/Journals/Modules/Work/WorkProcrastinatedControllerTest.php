...
final class WorkProcrastinatedControllerTest extends TestCase
{
    ...
    #[Test]
    public function it_logs_work_procrastinated_for_a_journal_entry(): void
    {
    ...
    #[Test]
    public function it_requires_work_procrastinated_to_be_valid(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create([
            'user_id' => $user->id,
    ...
    #[Test]
    public function it_requires_work_procrastinated_to_be_present(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create([
            'user_id' => $user->id,
    ...
    #[Test]
    public function it_rejects_work_procrastinated_updates_for_other_users_entries(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create();
