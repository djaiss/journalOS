...
final class ShoppingContextControllerTest extends TestCase
{
    ...
    #[Test]
    public function it_updates_shopping_context_with_alone_and_redirects(): void
    {
    ...
    #[Test]
    public function it_updates_shopping_context_with_partner_and_redirects(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create([
            'user_id' => $user->id,
    ...
    #[Test]
    public function it_updates_shopping_context_with_kids_and_redirects(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create([
            'user_id' => $user->id,
    ...
    public function it_validates_shopping_context_must_be_valid(): void
    {
        ...
        $response->assertSessionHasErrors('shopping_context');
    }
