...
final class PrimaryObligationControllerTest extends TestCase
{
    ...
    #[Test]
    public function it_updates_primary_obligation_with_work_and_redirects(): void
    {
        ...
        $response = $this->actingAs($user)->put(
            "/journals/{$journal->slug}/entries/2024/6/15/primary-obligation",
    ...
    #[Test]
    public function it_updates_primary_obligation_with_family_and_redirects(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create([
            'user_id' => $user->id,
    ...
    #[Test]
    public function it_updates_primary_obligation_with_personal_and_redirects(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create([
            'user_id' => $user->id,
    ...
    #[Test]
    public function it_updates_primary_obligation_with_health_and_redirects(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create([
            'user_id' => $user->id,
    ...
    #[Test]
    public function it_updates_primary_obligation_with_travel_and_redirects(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create([
            'user_id' => $user->id,
    ...
    #[Test]
    public function it_updates_primary_obligation_with_none_and_redirects(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create([
            'user_id' => $user->id,
    ...
    public function it_validates_primary_obligation_must_be_valid(): void
    {
        ...
        $response->assertSessionHasErrors('primary_obligation');
    }
    ...
    public function it_redirects_guests_to_login(): void
    {
        ...
        $response = $this->put("/journals/{$journal->slug}/entries/2024/6/15/primary-obligation", [
            'primary_obligation' => 'work',
        ]);
