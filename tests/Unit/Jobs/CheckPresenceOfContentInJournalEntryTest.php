...
final class CheckPresenceOfContentInJournalEntryTest extends TestCase
{
    ...
    #[Test]
    public function it_sets_has_content_to_true_when_cognitive_load_module_has_data(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create(['user_id' => $user->id]);
        $entry = JournalEntry::factory()->create([
    ...
    #[Test]
    public function it_sets_has_content_to_true_when_meals_module_has_data(): void
    {
        $user = User::factory()->create();
        $journal = Journal::factory()->create(['user_id' => $user->id]);
        $entry = JournalEntry::factory()->create([
