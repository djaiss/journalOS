    ...
    Route::middleware(['subscription'])->group(function (): void {
        ...
        Route::middleware(['journal'])->group(function (): void {
            ...
            Route::middleware(['journal.entry'])->group(function (): void {
                ...
                // toggle edit mode
                Route::get('journals/{slug}/entries/{year}/{month}/{day}/toggle-edit', [Journals\JournalEntryToggleController::class, 'edit'])
                    ->name('journal.entry.toggle-edit');
                ...
                Route::put('journals/{slug}/entries/{year}/{month}/{day}/reset', [Journals\JournalEntryResetController::class, 'update'])->name('journal.entry.reset');
