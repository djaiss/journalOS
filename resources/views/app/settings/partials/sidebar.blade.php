<aside class="flex-col border-b border-gray-200 bg-white px-4 py-4 sm:flex sm:rounded-bl-lg sm:border-r sm:border-b-0 dark:border-gray-700 dark:bg-gray-900">
  <nav class="flex flex-col gap-1">
    ...
    <a data-turbo="true" href="{{ route('settings.profile.index') }}" class="{{ request()->routeIs('settings.profile.index') ? 'bg-gray-100 font-medium text-gray-900 dark:bg-gray-800 dark:text-gray-100' : 'text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-800' }} flex items-center gap-3 rounded-lg px-2 py-1">
    ...
    <a data-turbo="true" href="#" class="flex items-center gap-3 rounded-lg px-2 py-1 text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-800">
