    ...
    <div class="space-y-4">
      ...
      <div class="space-y-2">
        ...
        <div class="flex w-full rounded-lg border border-gray-200 dark:border-gray-700">
          <x-button.yes name="has_traveled" value="yes" x-target="travel-container notifications travel-reset" :action="$module['has_traveled_url']" selected="{{ $entry->has_traveled_today === 'yes' }}" />
          <x-button.no name="has_traveled" value="no" x-target="travel-container notifications travel-reset" :action="$module['has_traveled_url']" selected="{{ $entry->has_traveled_today === 'no' }}" />
        </div>
      </div>
