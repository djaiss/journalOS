    ...
    <div>
      ...
      <div x-show="showWorkDetails" x-cloak class="mt-4 space-y-4">
        ...
        <div class="space-y-2">
          ...
          <div class="flex w-full rounded-lg border border-gray-200 dark:border-gray-700">
            <x-button.yes name="work_procrastinated" value="yes" x-target="work-container notifications work-reset days-listing months-listing" :action="$module['work_procrastinated_url']" selected="{{ $module['work_procrastinated'] === 'yes' }}" />
            <x-button.no name="work_procrastinated" value="no" x-target="work-container notifications work-reset days-listing months-listing" :action="$module['work_procrastinated_url']" selected="{{ $module['work_procrastinated'] === 'no' }}" />
          </div>
        </div>
      </div>
    </div>
