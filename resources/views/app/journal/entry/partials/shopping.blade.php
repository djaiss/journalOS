  ...
  <div id="shopping-container" class="space-y-4" x-data="{
    ...
    <div class="space-y-2">
      ...
      <div class="flex w-full rounded-lg border border-gray-200 dark:border-gray-700">
        <x-button.yes name="has_shopped" value="yes" x-target="shopping-container notifications shopping-reset days-listing months-listing" :action="$module['has_shopped_url']" selected="{{ $module['has_shopped_today'] === 'yes' }}" @click="showShoppingDetails = true" />
        <x-button.no name="has_shopped" value="no" x-target="shopping-container notifications shopping-reset days-listing months-listing" :action="$module['has_shopped_url']" selected="{{ $module['has_shopped_today'] === 'no' }}" @click="showShoppingDetails = false" />
      </div>
    </div>
      ...
      <div class="space-y-2">
        ...
        <div class="grid grid-cols-2 gap-2">
          @foreach ($module['shopping_intents'] as $option)
            <x-form x-target="shopping-container notifications shopping-reset days-listing months-listing" :action="$module['shopping_intent_url']" method="put">
      ...
      <div class="space-y-2">
        ...
        <div class="grid grid-cols-3 gap-2">
          @foreach ($module['shopping_contexts'] as $option)
            <x-form x-target="shopping-container notifications shopping-reset days-listing months-listing" :action="$module['shopping_context_url']" method="put">
      ...
      <div class="space-y-2">
        ...
        <div class="grid grid-cols-3 gap-2">
          @foreach ($module['shopping_for_options'] as $option)
            <x-form x-target="shopping-container notifications shopping-reset days-listing months-listing" :action="$module['shopping_for_url']" method="put">
