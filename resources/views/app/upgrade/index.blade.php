...
<x-app-layout>
  <x-breadcrumb :items="[
    ...
    ['label' => __('Upgrade your account')],
  ]" />

  <div class="flex h-[calc(100vh-48px)] flex-col items-center justify-center bg-gray-50 px-4 text-center sm:px-6 lg:px-8 dark:bg-gray-950">
    <div class="mx-auto mb-6 max-w-md overflow-hidden rounded-lg border border-gray-200 bg-white p-10 shadow-md dark:border-gray-700 dark:bg-gray-900">
      ...
      <!-- Call to action -->
      <div class="mt-8">
        <a href="" class="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-base font-medium text-white shadow-xs hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-hidden">
      ...
      <a href="https://lemonsqueezy.com" target="_blank" class="flex justify-center">
        <img src="{{ asset('images/lemonsqueezy.svg') }}" alt="LemonSqueezy" class="h-6" />
      </a>
    </div>
  </div>
</x-app-layout>
