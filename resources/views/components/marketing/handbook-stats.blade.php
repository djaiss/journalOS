...
<div class="mb-10 flex flex-col gap-y-2 text-sm">
  <div class="flex items-center gap-x-2">
    <x-phosphor-chart-line-up class="h-4 w-4 text-gray-500" />
...
<div class="text-sm">
  <div class="mb-2 flex items-center gap-x-2">
    <x-phosphor-lightbulb class="h-4 w-4 text-amber-500" />
    <h3 class="font-semibold">Random fact, so we don't die stupid</h3>
  </div>
