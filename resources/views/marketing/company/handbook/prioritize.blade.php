...
<x-marketing-handbook-layout :breadcrumbItems="[
  ...
  <div class="prose">
    ...
    <p class="mb-2">Now I'm not a regular business. I don't seek money and everywhere I can, I advocate that people should use the Docker image and host JournalOS themselves instead of relying on the version I host. Even though the software is as secured as it can be, it won't replace a system that you own completely.</p>
