...
<x-marketing-handbook-layout :breadcrumbItems="[
  ...
  ['label' => 'Who I am and what is this project'],
]">
  <h1 class="mb-6 text-2xl font-bold dark:text-gray-100">Who I am and what is this project</h1>

  <div class="prose dark:prose-invert">
    <p class="mb-2">JournalOS is a side project that I've started in Decembre 2024. I worked a lot on another very successful side project called Monica, which I believe was the first personal CRM. After 8 years on this project, I wanted to change and do something different.</p>
