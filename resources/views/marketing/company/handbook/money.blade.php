...
<x-marketing-handbook-layout :breadcrumbItems="[
  ...
  <div class="prose">
    ...
    <p class="mb-2">This project makes money by selling an access to the instance of JournalOS that I own. For a single, one-time fee, you will have access to it forever, without being locked in. It's simple, really.</p>
