    ...
    <script type="application/ld+json">
      {
        ...
        "operatingSystem": "All",
        "logo": "https://journalos.cloud/marketing/logo-full.png",
        ...
        "description": "JournalOS is a personal CRM software that helps you remember and manage your relationships.",
        "inLanguage": "en",
  ...
  <div class="relative bg-white">
    <div class="mx-auto max-w-7xl px-6 py-8 text-center sm:pt-20 sm:pb-8 lg:px-8 xl:px-0">
      ...
      <p class="mt-6 text-lg leading-8 text-gray-600">
        {{ __('JournalOS helps you be more intentional with your relationships by keeping track of the important details about people in your life.') }}
      </p>
    ...
    <div class="mx-auto max-w-4xl rounded-lg bg-green-100 px-6 py-4">
      <div class="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-3 lg:items-center">
        <div class="col-span-2">
          ...
          <p class="mb-2">JournalOS is designed for people with jobs, families, and busy lives who are striving to maintain a good work-life balance. They're often so busy that they forget to call a friend, wish a nephew a happy birthday, or invite someone special to dinner next week. As we grow older, life increasingly gets in the way. It's unfortunate, but it's the reality.</p>
          <p class="mb-2">We've created JournalOS to remember all these little, but so important, things.</p>
          <p>
            Read more about
