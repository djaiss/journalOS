...
<x-marketing-layout>
  ...
  <div class="relative bg-white dark:bg-gray-900">
    <div class="mx-auto max-w-7xl px-6 py-8 text-center sm:pt-20 sm:pb-8 lg:px-8 xl:px-0">
      <h1 class="text-4xl font-semibold tracking-tight text-gray-900 sm:text-6xl dark:text-gray-100">{{ __('A simple diary to track the shape of your days.') }}</h1>
      <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
        {{ __('JournalOS is a bullet journal that helps you log sleep, mood, health, work, and more without writing long essays.') }}
      </p>
  ...
  <div id="features" class="bg-gray-50 py-12 dark:bg-gray-800">
    <div class="mx-auto max-w-7xl px-6 lg:px-8 xl:px-0">
      ...
      <div class="mx-auto max-w-2xl lg:text-center">
        <h2 class="text-base leading-7 font-semibold text-green-600">{{ __('Your personal diary') }}</h2>
        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-gray-100">
          {{ __('Every feature is crafted to help you remember your days with clarity') }}
        </p>
      </div>
        ...
        <dl class="mb-20 grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
          ...
          <div class="flex flex-col">
            ...
            <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400">
              <p class="flex-auto">{{ __('Track your day in minutes with structured prompts like sleep, mood, health, work, and more.') }}</p>
            </dd>
          </div>
          ...
          <div class="flex flex-col">
            <dt class="flex items-center gap-x-3 text-base leading-7 font-semibold text-gray-900 dark:text-gray-100">
              ...
              {{ __('No long essays required') }}
            </dt>
            <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400">
              <p class="flex-auto">{{ __('Capture the essentials quickly so journaling stays sustainable, even on busy days.') }}</p>
            </dd>
          </div>
          ...
          <div class="flex flex-col">
            <dt class="flex items-center gap-x-3 text-base leading-7 font-semibold text-gray-900 dark:text-gray-100">
              ...
              {{ __('Protect past entries') }}
            </dt>
            <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400">
              <p class="flex-auto">{{ __('Lock older entries so your record stays honest and consistent over time.') }}</p>
            </dd>
          </div>
        </dl>
        ...
        <dl class="mb-20 grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
          ...
          <div class="flex flex-col">
            <dt class="flex items-center gap-x-3 text-base leading-7 font-semibold text-gray-900 dark:text-gray-100">
              ...
              {{ __('Monthly and yearly stats') }}
            </dt>
            <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400">
              <p class="flex-auto">{{ __('See trends and patterns across weeks, months, and years with simple summaries.') }}</p>
            </dd>
          </div>
          ...
          <div class="flex flex-col">
            ...
            <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400">
              <p class="flex-auto">{{ __('Get gentle email reminders of what happened in the past to bring moments back to life.') }}</p>
            </dd>
          </div>
          ...
          <div class="flex flex-col">
            <dt class="flex items-center gap-x-3 text-base leading-7 font-semibold text-gray-900 dark:text-gray-100">
              ...
              {{ __('English and French') }}
            </dt>
            <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400">
              <p class="flex-auto">{{ __('Fully translated so your journal feels natural in the language you use every day.') }}</p>
            </dd>
          </div>
        </dl>
        ...
        <div class="mx-auto text-center">
          <a href="" class="group mb-3 inline-flex items-center gap-x-2 rounded-sm border border-b-3 border-gray-400 bg-white px-3 py-2 transition-colors duration-150 hover:bg-white dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600">
            ...
            <span class="text-sm text-gray-700 group-hover:text-gray-900 dark:text-gray-300 dark:group-hover:text-gray-100">
              {{ __('See every module you can track') }}
            </span>
          </a>
          <p class="text-sm text-gray-600 italic dark:text-gray-400">{{ __('A diary that stays simple, fast, and genuinely useful.') }}</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 xl:px-0">
      ...
      <div class="mx-auto mb-10 max-w-2xl lg:text-center">
        <p class="mb-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-gray-100">
          {{ __('JournalOS is proudly open source.') }}
        </p>
    ...
    <div class="mx-auto max-w-4xl rounded-lg bg-green-100 px-6 py-4 dark:bg-green-900/30">
      <div class="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-3 lg:items-center">
        <div class="col-span-2">
          <h2 class="mb-3 text-xl leading-7 font-semibold text-green-600 dark:text-green-400">{{ __('Why should you use JournalOS?') }}</h2>
          ...
          <p class="dark:text-gray-300">
            Read more about
            <a href="" class="text-blue-500 hover:underline">{{ __('why this tool exists') }}</a>
            .
          </p>
        </div>
  ...
  <div id="privacy" class="bg-gray-50 py-12 sm:py-20 dark:bg-gray-800">
    <div class="mx-auto max-w-7xl px-6 lg:px-8 xl:px-0">
      <h3 class="mt-2 mb-3 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-gray-100">
        {{ __('Privacy and transparency are at the core of what we do.') }}
      </h3>
      <p class="mb-10 text-xl dark:text-gray-300">{{ __('You are not our product. You are the reason we exist.') }}</p>
      ...
      <div class="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-4">
        <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-900/50">
          ...
          <h4 class="mb-3 text-center text-lg font-bold dark:text-gray-100">{{ __('Transparent by nature') }}</h4>
          <p class="dark:text-gray-400">{{ __('Our code is open source, so you can see exactly how we build JournalOS.') }}</p>
        </div>
        <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-900/50">
          <div class="mb-2 flex justify-center">
            <x-phosphor-lock class="h-6 w-6 text-green-600" />
          </div>
          <h4 class="mb-3 text-center text-lg font-bold dark:text-gray-100">{{ __('Data is encrypted at rest') }}</h4>
          <p class="dark:text-gray-400">{{ __('We use industry-standard encryption to protect your data. If someone would steal the database, they would only see a bunch of gibberish.') }}</p>
        </div>
        <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-900/50">
          <div class="mb-2 flex justify-center">
            <x-phosphor-eye-slash class="h-6 w-6 text-green-600" />
          </div>
          <h4 class="mb-3 text-center text-lg font-bold dark:text-gray-100">{{ __('We do not track you') }}</h4>
          <p class="dark:text-gray-400">{{ __('There are no JavaScript trackers or ads on this website. We only measure page views to improve the site.') }}</p>
        </div>
        <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-900/50">
          <div class="mb-2 flex justify-center">
            <x-phosphor-brain class="h-6 w-6 text-green-600" />
          </div>
          <h4 class="mb-3 text-center text-lg font-bold dark:text-gray-100">{{ __('No AI shortcuts') }}</h4>
          <p class="dark:text-gray-400">{{ __('We do not rely on AI in the application. It is not ready for prime time and would create privacy issues.') }}</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-0">
      <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
        <h2 class="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">
          {{ __('Take control of your days and go out there. Life is not lived in front of a computer screen.') }}
        </h2>
        <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
          {{ __('But if you cannot, we can help with a simple tool to remember what matters.') }}
        </p>
