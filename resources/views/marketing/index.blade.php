...
<x-marketing-layout>
  ...
  <div class="relative bg-white">
    <div class="mx-auto max-w-7xl px-6 py-8 text-center sm:pt-20 sm:pb-8 lg:px-8 xl:px-0">
      <h1 class="text-4xl font-semibold tracking-tight text-gray-900 sm:text-6xl">{{ __('A simple diary to track the shape of your days.') }}</h1>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 xl:px-0">
      ...
      <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:max-w-none">
        ...
        <div class="mx-auto text-center">
          ...
          <p class="text-sm text-gray-600 italic">{{ __('A diary that stays simple, fast, and genuinely useful.') }}</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 xl:px-0">
      ...
      <div class="mx-auto mb-10 max-w-2xl lg:text-center">
        <div class="flex items-center justify-center gap-x-8">
          <a href="https://github.com/djaiss/journalos" target="_blank" class="group inline-flex items-center gap-x-2 rounded-sm border border-b-3 border-gray-400 bg-white px-3 py-2 transition-colors duration-150 hover:bg-gray-50">
          ...
          <a href="https://github.com/djaiss/journalos" target="_blank" class="group inline-flex items-center gap-x-2 rounded-sm border border-b-3 border-gray-400 bg-white px-3 py-2 transition-colors duration-150 hover:bg-gray-50">
            ...
            <span class="rounded-full bg-gray-100 px-2 py-0.5 font-mono text-xs text-gray-700">{{ $stars ?? 0 }}</span>
          </a>
    ...
    <div class="mx-auto max-w-4xl rounded-lg bg-green-100 px-6 py-4">
      <div class="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-3 lg:items-center">
        <div class="col-span-2">
          <h2 class="mb-3 text-xl leading-7 font-semibold text-green-600">{{ __('Why should you use JournalOS?') }}</h2>
          <p class="mb-2">JournalOS is designed for people with busy lives who want a simple way to remember how their days felt. If you do not want to write long essays but still want to track your life, this is for you.</p>
          <p class="mb-2">We built it so you can capture the important details quickly and still look back with clarity.</p>
          <p>
            Read more about
      ...
      <div class="mx-auto mb-10 max-w-7xl">
        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-4">
          <div class="rotate-2 rounded-lg border border-gray-200 bg-white p-4">
            ...
            <p class="mb-3 text-xl">You remember every detail</p>
            <p class="text-sm">If your memory already captures every day, you probably do not need this tool.</p>
          </div>
          ...
          <div class="-rotate-1 rounded-lg border border-gray-200 bg-white p-4">
            ...
            <p class="text-sm">We do not track users to serve ads, and we do not profile our users.</p>
          </div>
          ...
          <div class="rotate-2 rounded-lg border border-gray-200 bg-white p-4">
            ...
            <p class="text-sm">We believe you should self-host on your own server if you can.</p>
          </div>
        </div>
      </div>
    </div>
