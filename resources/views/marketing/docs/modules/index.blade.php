...
<x-marketing-docs-layout>
  <div class="grid grid-cols-1 gap-x-16 lg:grid-cols-[1fr_250px]">
    <div class="py-16 sm:border-r sm:border-gray-200 sm:pr-10 dark:sm:border-gray-700">
      ...
      <p class="mb-8 text-gray-700 dark:text-gray-300">Every module must clearly answer the question: <em>Which part of my life does this describe?</em>. If a module does not fit cleanly into one of these five, it likely does not belong in {{ config('app.name') }}.</p>

      <x-marketing.docs.h2 id="category-overview" title="Category overview" />

      <h3 class="mb-4 mt-6 text-2xl font-bold text-gray-900 dark:text-gray-100">💪 Body & Health</h3>
      ...
      <h3 class="mb-4 mt-6 text-2xl font-bold text-gray-900 dark:text-gray-100">🧠 Mind & Emotions</h3>
      <h4 class="mb-2 font-semibold text-gray-900 dark:text-gray-100">What it represents</h4>
      ...
      <h3 class="mb-4 mt-6 text-2xl font-bold text-gray-900 dark:text-gray-100">💼 Work</h3>
      <h4 class="mb-2 font-semibold text-gray-900 dark:text-gray-100">What it represents</h4>
      ...
      <h3 class="mb-4 mt-6 text-2xl font-bold text-gray-900 dark:text-gray-100">👥 Social</h3>
      <h4 class="mb-2 font-semibold text-gray-900 dark:text-gray-100">What it represents</h4>
      ...
      <h3 class="mb-4 mt-6 text-2xl font-bold text-gray-900 dark:text-gray-100">📍 Places</h3>
      <h4 class="mb-2 font-semibold text-gray-900 dark:text-gray-100">What it represents</h4>
    ...
    <div class="mb-10 hidden w-full flex-shrink-0 flex-col justify-self-end lg:flex pt-16">
      ...
      <div class="flex flex-grow items-end">
        <div class="sticky bottom-0 w-full">
          <!-- Table of Contents -->
          <div class="mb-4">
            <h4 class="mb-2 text-xs font-semibold uppercase text-gray-500 dark:text-gray-400">Jump to</h4>
