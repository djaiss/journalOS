...
<x-marketing-docs-layout :breadcrumbItems="[
  ...
  <div class="py-16">
    <x-marketing.docs.h1 title="Mood module" />
    ...
    <div class="mb-10 grid grid-cols-1 gap-6 border-b border-gray-200 pb-10 sm:grid-cols-2 dark:border-gray-700">
      <div>
        <p class="mb-2">The mood module endpoint lets you log your mood on a specific day.</p>
        ...
        <x-marketing.docs.code title="Endpoints">
          <div class="flex flex-col gap-y-2">
            <a href="#log-mood">
              ...
              /api/journals/{id}/{year}/{month}/{day}/mood
            </a>
          </div>
    ...
    <!-- PUT /api/journals/{id}/{year}/{month}/{day}/mood -->
    <div class="mb-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
      <div>
        <x-marketing.docs.h2 id="log-mood" title="Log mood" />
        <p class="mb-10">This endpoint logs your mood for a journal entry.</p>
        ...
        <x-marketing.docs.query-parameters>
          <x-marketing.docs.attribute required name="mood" type="string" description="Your mood on that day. Accepted values are: terrible, bad, okay, good, great." />
        </x-marketing.docs.query-parameters>
      ...
      <div>
        <x-marketing.docs.code title="/api/journals/{id}/{year}/{month}/{day}/mood" verb="PUT" verbClass="text-yellow-700">
