<x-marketing-docs-layout :breadcrumbItems="[
  ...
  <div class="py-16">
    <x-marketing.docs.h1 title="Prune account" />
    ...
    <div class="mb-10 grid grid-cols-1 gap-6 border-b border-gray-200 pb-10 sm:grid-cols-2">
      <div>
        <p class="mb-2">This endpoint prunes the account by deleting all journals and related data.</p>
        <p class="mb-2">Use this action when a user wants to reset their account data while keeping their login.</p>
      </div>
      <div>
