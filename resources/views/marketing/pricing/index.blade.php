...
<x-marketing-layout :breadcrumbItems="[
  ...
  <div class="relative mx-auto max-w-7xl px-6 py-16 lg:px-8 xl:px-0">
    <h1 class="mb-4 text-center text-3xl tracking-tight text-gray-900">
    ...
    <div class="mx-auto max-w-3xl px-6 lg:px-8 xl:px-0">
      ...
      <div class="relative rounded-2xl border-2 border-yellow-400 bg-white p-8">
        ...
        <ul class="mb-8 space-y-4">
          <li class="flex items-start gap-x-3">
            <x-phosphor-check class="h-6 w-6 flex-none text-green-600" />
            <div>
          ...
          <li class="flex items-start gap-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">
                It's <a href="https://github.com/djaiss/journalOS/blob/main/LICENSE" class="text-blue-500 hover:underline">MIT licensed</a>.
              </p>
            </div>
          </li>
          <li class="flex items-start gap-x-3">
        ...
        <div class="mt-8">
          <a href="https://github.com/djaiss/journalOS/blob/main/docs/docker.md" class="group inline-flex w-full items-center gap-x-2 rounded-sm border border-b-3 border-gray-400 px-3 py-2 transition-colors duration-150 hover:bg-white">
            <img src="{{ asset('images/marketing/docker.svg') }}" width="32" height="32" alt="Docker" class="mr-2 inline-block h-8 w-8" loading="lazy" />
      ...
      <div class="rounded-2xl border border-gray-200 bg-white p-8">
        ...
        <ul class="mb-8 space-y-4">
          <li class="flex items-start gap-x-3">
            <x-phosphor-check class="h-6 w-6 flex-none text-green-600" />
            <div>
              <span class="font-semibold">Unlimited journal entries</span>
      ...
      <div class="space-y-6">
        <div class="border-b border-gray-200 pb-5">
          ...
          <div class="mt-2 text-gray-600">
            <p class="mb-2">If you want complete security and privacy, we strongly, strongly urge you to host your own instance of JournalOS.</p>
            <p>
        ...
        <div class="border-b border-gray-200 pb-5">
          ...
          <div class="mt-2 text-gray-600">
            <p class="mb-2">Again. If you want complete privacy, do not use our online service, and no other online services for that matter. Install JournalOS on your own hardware. It's legal, it's free.</p>
        ...
        <div class="border-b border-gray-200 pb-5">
          ...
          <div class="mt-2 text-gray-600">
            ...
            <p>Please, be sure before you unlock JournalOS. Credit card disputes cost us $20 per dispute, and it's not fun for everyone. The purchasing flow will actually discourage you from buying the product if you're not sure about it.</p>
          </div>
        </div>
        ...
        <div class="border-b border-gray-200 pb-5">
          ...
          <div class="mt-2 text-gray-600">
            <p class="mb-2">If the case you have an existing local JournalOS instance, you would want to import your data to our instance of JournalOS. Short answer: you can't do that. We only do an export, not an import. Why? Because of security issues. Honestly, it would be too much of a risk to insert the data directly into the database.</p>
            <p>For all the conspiracy theorists out there, no, it's not because I want to keep your data forever. I actually want everyone to run their own instances of JournalOS, so I'm free of the responsibility of your data.</p>
          </div>
        </div>
