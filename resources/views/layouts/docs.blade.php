        ...
        <div
          ...
          <div x-show="openApiDocumentation" x-cloak class="mb-10 ml-3">
            ...
            <div x-show="accountManagementDocumentation" class="mb-3 flex flex-col gap-y-2">
              ...
              <div>
                <a href="{{ route('marketing.docs.api.account.prune') }}" wire:navigate class="{{ request()->routeIs('marketing.docs.api.account.prune') ? 'border-l-blue-400' : 'border-l-transparent' }} block border-l-3 pl-3 hover:border-l-blue-400 hover:underline">Manage account</a>
              </div>
            </div>
