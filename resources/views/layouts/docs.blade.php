        ...
        <div
          ...
          <div x-show="conceptsDocumentation" x-cloak class="mb-2 ml-3">
            <div class="mb-3 flex flex-col gap-y-2">
              <div>
                <a href="{{ route('marketing.docs.concepts.modules') }}" class="{{ request()->routeIs('marketing.docs.concepts.modules') ? 'border-l-blue-400' : 'border-l-transparent' }} block border-l-3 pl-3 hover:border-l-blue-400 hover:underline">Modules</a>
              </div>
            </div>
          </div>
          ...
          <div x-show="openApiDocumentation" x-cloak class="mb-10 ml-3">
            ...
            <div x-show="modulesDocumentation" class="mb-3 flex flex-col gap-y-2">
              ...
              <div>
                <a href="{{ route('marketing.docs.api.modules.meals') }}" class="{{ request()->routeIs('marketing.docs.api.modules.meals') ? 'border-l-blue-400' : 'border-l-transparent' }} block border-l-3 pl-3 hover:border-l-blue-400 hover:underline">Meals</a>
              </div>
              <div>
              ...
              <div>
                <a href="{{ route('marketing.docs.api.modules.reading') }}" class="{{ request()->routeIs('marketing.docs.api.modules.reading') ? 'border-l-blue-400' : 'border-l-transparent' }} block border-l-3 pl-3 hover:border-l-blue-400 hover:underline">Reading</a>
              </div>
              <div>
